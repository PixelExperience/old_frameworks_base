...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        mHasNavigationBar = NavbarUtils.isNavigationBarEnabled(mContext);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            final boolean navBarEnabled = Settings.Secure.getIntForUser(resolver,
                    Settings.Secure.NAVIGATION_BAR_ENABLED, NavbarUtils.hasNavbarByDefault(mContext) ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                ...
                if (mUseTvRouting || mHandleVolumeKeysInWM) {
                    ...
                    if (!interactive && mVolumeMusicControl && isMusicActive()) {
                        ...
                        if (mVolumeRockerWake && (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP) && !isScreenOn() && notHandledMusicControl){
                            // Turn screen on
                            isWakeKey = true;
