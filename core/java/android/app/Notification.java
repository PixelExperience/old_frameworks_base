...
public class Notification implements Parcelable
{
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification toAdopt, Context themeContext) {
            ...
            mInNightMode = mInNightMode || res.getBoolean(R.bool.config_useDarkBgNotificationTinting_override);
        ...
        private CharSequence processTextSpans(CharSequence text) {
            if (hasForegroundColor()) {
                ...
                .getBoolean(R.bool.config_useDarkBgNotificationTinting_override)) {
