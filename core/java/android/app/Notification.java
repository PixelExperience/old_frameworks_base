...
public class Notification implements Parcelable
{
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification toAdopt, Context themeContext) {
            ...
            mInNightMode = getColorUtil().shouldUseDarkNotification(mContext);
        ...
        private CharSequence processTextSpans(CharSequence text) {
            if (hasForegroundColor()) {
                ...
                .getBoolean(R.bool.config_useDarkNotification)) {
        ...
        private CharSequence processLegacyText(CharSequence charSequence, boolean ambient) {
            ...
            boolean wantLightText = ambient || getColorUtil().shouldUseDarkNotification(mContext);
