...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private void enableProximityListener() {
        ...
        boolean mProximityWakeSupported = mContext.getResources().getBoolean(
        ...
        boolean proximityWakeCheckEnabledOnFP = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_proximityCheckOnFingerprintWake);

        if(!proximityWakeCheckEnabled || !mProximityWakeSupported || !proximityWakeCheckEnabledOnFP || mSensor == null || mSensorEventListener != null){
            return;
        }
