...
public class KeyguardSliceView extends LinearLayout implements View.OnClickListener,
    ...
    private void showSlice() {
        ...
        for (int i = startIndex; i < subItemsCount; i++) {
            ...
            final boolean isWeatherSlice = itemTag.equals(KeyguardSliceProvider.KEYGUARD_WEATHER_URI);
            // Try to reuse the view if already exists in the layout
            KeyguardSliceButton button = mRow.findViewWithTag(itemTag);
            Log.d("teste", itemTag.toString());
            Log.d("teste", isWeatherSlice ? "isWeather" : "isn't weather");
            if (button == null) {
                button = new KeyguardSliceButton(mContext);
                button.setshouldTintDrawable(!isWeatherSlice/*mPulsing*/);
