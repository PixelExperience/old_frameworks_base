...
public class CurrentWeatherView extends FrameLayout implements WeatherClient.WeatherObserver {
    ...
    // getWeatherConditionImage(String conditions)

    // getWeatherTemperature(int temperatureMetric, temperatureImperial)
    ...
    private void updateWeatherData(WeatherClient.WeatherInfo weatherData) {
        ...
        setVisibility(View.GONE);
/*
        Drawable d = mWeatherClient.getWeatherConditionImage(conditions);
        d = d.mutate();
        updateTint(d);
        mCurrentImage.setImageDrawable(d);
        mRightText.setText(mWeatherClient.getWeatherTemperature());
        setVisibility(View.VISIBLE);*/
    }
