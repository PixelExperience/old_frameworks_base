...
public class KeyguardSliceProvider extends SliceProvider implements
    ...
    private class WeatherSettingsObserver extends ContentObserver {
        ...
        public void updateLockscreenUnit() {
            useMetricUnit = Settings.System.getIntForUser(mContentResolver, Settings.System.WEATHER_LOCKSCREEN_UNIT, getContext().getInteger(com.android.internal.R.integer.weather_lockscreen_default_unit), UserHandle.USER_CURRENT) == 0;
        }
    }
