    ...
    private class RecorderThread extends Thread {
            ...
            if (!isRecording) {
                new Thread() {
                    public void run() {
                        ...
                        parseResult(AuddApi.sendRequest(mManager, buffCopy));
                    }
                }.start();
            } else {
        ...
        private void parseResult(String result) {
            ...
            try {
                ...
                if (jsonResult.getString("status") != null && jsonResult.getString("status").equals("success") && jsonResult.getJSONObject("result") != null) {
