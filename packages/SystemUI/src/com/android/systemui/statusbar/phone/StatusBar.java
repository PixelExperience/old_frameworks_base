...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void updateTheme(boolean fromPowerSaveCallback) {
        ...
        boolean darkThemeNeeded;
        if (fromPowerSaveCallback && DARK_THEME_IN_NIGHT_MODE){
            darkThemeNeeded = mIsOnPowerSaveMode;
        }else{
            // The system wallpaper defines if QS should be light or dark.
            WallpaperColors systemColors = mColorExtractor
                    .getWallpaperColors(WallpaperManager.FLAG_SYSTEM);
            darkThemeNeeded = systemColors != null
                    && (systemColors.getColorHints() & WallpaperColors.HINT_SUPPORTS_DARK_THEME) != 0;
            if (!darkThemeNeeded && DARK_THEME_IN_NIGHT_MODE && mIsOnPowerSaveMode){
