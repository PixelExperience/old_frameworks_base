...
public class StatusBar extends SystemUI implements DemoMode,
                ...
                public void run() {
                    if (mRecognitionEnabled && mRecognitionEnabledOnKeyguard){
                        ...
                        if (isKeyguardShowing()){
                            ...
                            hideAmbientPlayIndication(mAmbientIndicationManager.getAmbientClearViewInterval(), false);
                        }
                    }else{
                        hideAmbientPlayIndication(0, true);
                    }
    ...
    private void hideAmbientPlayIndication(int interval, boolean forceClear){
        try {
