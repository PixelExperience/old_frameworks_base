...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadDefaultAnimationSettings(SQLiteStatement stmt) {
        loadFloatSetting(stmt, Settings.System.WINDOW_ANIMATION_SCALE,
                R.dimen.def_window_animation_scale, 1);
        loadFloatSetting(stmt, Settings.System.TRANSITION_ANIMATION_SCALE,
                R.dimen.def_window_transition_scale, 1);
    }
    ...
    private void loadFloatSetting(SQLiteStatement stmt, String key, int resid, int base) {
        loadSetting(stmt, key,
                Float.toString(mContext.getResources().getFloat(resid, base, base)));
    }
